-- CreateEnum
CREATE TYPE "GameType" AS ENUM ('ONE_PIECE', 'POKEMON', 'YUGIOH', 'NARUTO');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('PARTICIPATION_REQUEST', 'PARTICIPATION_ACCEPTED', 'PARTICIPATION_REJECTED', 'PARTICIPATION_CANCELLED', 'NEW_MESSAGE', 'GAME_CANCELLED', 'GAME_FULL');
...
CREATE TABLE "games" (
    ...
    "wasFilledOnce" BOOLEAN NOT NULL DEFAULT false,
